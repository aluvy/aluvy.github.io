...
![alt text](/assets/images/posts/2022/03/02/git-01.png)
...
![alt text](/assets/images/posts/2022/03/02/git-02.png)
...
![alt text](/assets/images/posts/2022/03/02/git-03.png)
_vscode 확장 Git History 설치_


1. git_ex폴더를 작업영역폴더로 추가한 후, 터미널>새터미널을 연다. 

![alt text](/assets/images/posts/2022/03/02/git-04.png)
_vscode에서 작업폴더 잡은 후 터미널열기_


6. 터미널 창 우측에 +버튼을 클릭 해 Git Bash를 선택한다.

![alt text](/assets/images/posts/2022/03/02/git-05.png)
_우측 + 설정 Git Bash로 변경_


7. 제대로 세팅된 화면에 $ git status 명령어를 쳐봤다.

![alt text](/assets/images/posts/2022/03/02/git-06.png)
_폴더 경로를 꼭 확인한다!!_
...
![alt text](/assets/images/posts/2022/03/02/git-07.png)
_생성되면 (master)가 붙는다._


![alt text](/assets/images/posts/2022/03/02/git-08.png)
_$ git init_
...
![alt text](/assets/images/posts/2022/03/02/git-09.png)
...
![alt text](/assets/images/posts/2022/03/02/git-10.png)
...
![alt text](/assets/images/posts/2022/03/02/git-11.png)
...
![alt text](/assets/images/posts/2022/03/02/git-12.png)
_출처 -&amp;nbsp;https://webclub.tistory.com/321?category=546363_


![alt text](/assets/images/posts/2022/03/02/git-13.png)
_출처 -&amp;nbsp;https://webclub.tistory.com/321?category=546363_
...
![alt text](/assets/images/posts/2022/03/02/git-14.png)
